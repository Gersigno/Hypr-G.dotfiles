{
    ...
    "tokenColors": [
      ...
      {
        "name": "[VSCODE-CUSTOM] Markdown Punctuation Definition Italic",
    ...
    "colors": {
      ...
      "titleBar.inactiveForeground": "{{colors.on_surface.default.hex}}",
      ...
      "editor.background": "{{colors.surface_container_lowest.default.hex}}",
      ...
      "peekViewResult.matchHighlightBackground": "{{colors.tertiary.default.hex}}40",
      "peekViewResult.selectionBackground": "{{colors.primary.default.hex}}40",
      ...
      "tab.inactiveBackground": "{{colors.surface_bright.default.hex}}",
      ...
      "terminal.ansiBrightBlack": "{{colors.surface.default.hex}}",
