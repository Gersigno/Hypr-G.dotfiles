function _tide_print_item -a item
    ...
    if set -e add_prefix
        ...
        v=tide_"$_tide_side"_prompt_separator_same_color echo -ns (set_color $item_bg_color -b normal)$$v
    else if test $_tide_side = left
        set_color $prev_bg_color -b normal
        echo -ns $tide_left_prompt_separator_diff_color
        set_color brblack -b $item_bg_color
        echo -ns $tide_left_prompt_separator_diff_color
    else
        set_color brblack -b $prev_bg_color
