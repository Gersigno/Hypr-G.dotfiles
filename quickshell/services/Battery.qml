...
Singleton {
    ...
    property real percentage: (UPower.displayDevice?.percentage * 100) ?? 1

    property bool isLow: available && (percentage <= 20)
    property bool isCritical: available && (percentage <= 10)
    property bool isSuspending: available && (percentage <= 5)
    property bool isFull: available && (percentage >= 100)

    property bool isLowAndNotCharging: isLow && !isCharging
    property bool isCriticalAndNotCharging: isCritical && !isCharging
    property bool isSuspendingAndNotCharging: isSuspending && !isCharging
